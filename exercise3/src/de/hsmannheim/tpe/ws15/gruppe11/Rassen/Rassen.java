...
public class Rassen {
		 ...
		 * @param rüstung
		 */
		public Rassen (double leben, double schaden, double geschwindigkeit, double rüstung, int preis) {
			this.leben = leben;
		...
		public String toString() {
			return "Rassen [leben =" + leben + ", ruestung = " + ruestung + ", schaden ="
					+ schaden + ", geschwindigkeit =" + geschwindigkeit + ", kosten = " + "]";
		}
